...
## Executive Summary
This case documents suspicious behavior associated with **identity reconnaissance and username discovery**. The purpose of the writeup is to show how an analyst should move from a QRadar offense title to a defensible security assessment.

## Detection Trigger
- **Observed Theme:** Identity Reconnaissance And Username Discovery
