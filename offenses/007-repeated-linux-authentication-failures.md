...
## Executive Summary
This case documents suspicious behavior associated with **Linux / SSH authentication abuse**. The purpose of the writeup is to show how an analyst should move from a QRadar offense title to a defensible security assessment.

## Detection Trigger
- **Observed Theme:** Linux / Ssh Authentication Abuse
