...
## Executive Summary
This case documents suspicious behavior associated with **reconnaissance and unauthorized host interest**. The purpose of the writeup is to show how an analyst should move from a QRadar offense title to a defensible security assessment.

## Detection Trigger
- **Observed Theme:** Reconnaissance And Unauthorized Host Interest
